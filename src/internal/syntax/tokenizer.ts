...
function isWhitespace(value: number | null): boolean {
  return value === 0x09 || value === 0x0a || value === 0x20;
}

function isDigit(value: number | null): boolean {
  return value !== null && value >= 0x30 && value <= 0x39;
}

function isHexDigit(value: number | null): boolean {
  return (
    isDigit(value) ||
...
function isAsciiLetter(value: number | null): boolean {
  return (
...
function isNonPrintable(value: number | null): boolean {
  return (
    value !== null &&
    (
